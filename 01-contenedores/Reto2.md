...
Que ha aplicado correctamente las variables de entorno por que ha comunicado correctamente con el contenedor de Mongo por la red Bridge usando el nobre de dominio "some-mongo" y he podido acceder a la app desde el host por cambiar la variable HOST a 0.0.0.0
